...
# -*- coding: utf-8 -*-
#
# pyCOLA documentation build configuration file, created by
# sphinx-quickstart2 on Wed Jun 25 08:04:02 2014.
#
...
exclude_patterns = ["_build", "setup.py", "build"]
...
latex_documents = [
    ("index", "pyCOLA.tex", "pyCOLA Documentation", "Svetlin Tassev", "manual"),
]
...
man_pages = [("index", "pycola", "pyCOLA Documentation", ["Svetlin Tassev"], 1)]
